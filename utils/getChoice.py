...
def getChoice(question , choices , cancel = False):#TODO! вставить красивый вывод (Когда сделаю listFormat)
	if len(choices)>=1:
		print(question)
		if cancel == True:
				print ("0. Cancel")
		for index, choice in enumerate(choices):
			print("{0}. {1}".format(index+1, choice))# Для вывода элемента из choices вызывается __str__()
